...
RescheduleWindowUseCase rescheduleWindow(RescheduleWindowRef ref) {
  final quietHours = ref.watch(quietHoursNotifierProvider).valueOrNull
      ?? const QuietHoursState();
  return RescheduleWindowUseCase(
    ...
    alarmConfigDao: ref.watch(appDatabaseProvider).alarmConfigDao,
    ...
    isQuietTime: quietHours.isQuiet,
  );
}
